...
class Discriminator(torch.nn.Module):
    def __init__(self,
        ...
        if cmap_dim > 0:
            ...
            print("Initialized proj_ijepa_d")
        else:
    ...
    def forward(self, img, c, t, e_ijepa=None, sem_ramp = 0.0, **block_kwargs):
        x = None
        for res in self.block_resolutions:
            block = getattr(self, f'b{res}')
        ...
        cmap = normalize_2nd_moment((1.0 - blend_ratio) * cmap + blend_ratio * cmap_e)
