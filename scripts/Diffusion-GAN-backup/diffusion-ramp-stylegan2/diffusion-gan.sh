#!/bin/bash
#SBATCH -A standby
#SBATCH -J SD-ChestXray_labelled
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/stylegan2-ada-pytorch/SLURM_OUTPUT_FILES/Chest_Xray_labelled_SGDiff.out
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/stylegan2-ada-pytorch/SLURM_OUTPUT_FILES/Chest_Xray_labelled_SGDiff.err
