#!/bin/bash
#SBATCH -A standby
#SBATCH -J ijepa_ChestXray_rampGD_warmup_5.4_4gpu_sem_mix_0.9_gamma
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/diffusion-ramp-stylegan2/SLRUM_OUTPUT_FILES/ijepa_ChestXray_rampGD_warmup_5.4_4gpu_sem_mix_0.9_gamma.out
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/diffusion-ramp-stylegan2/SLRUM_OUTPUT_FILES/ijepa_ChestXray_rampGD_warmup_5.4_4gpu_sem_mix_0.9_gamma.err
