...
def main(**kwargs):
    ...
    c.G_kwargs.mapping_kwargs.sem_mixing_prob = opts.sem_mixing_prob
    c.G_kwargs.mapping_kwargs.fusion_alpha = opts.fusion_alpha
    ...
    c.loss_kwargs = dnnlib.EasyDict(class_name='training.loss.ProjectedGANLoss',
                                    ijepa_ckpt=opts.ijepa_checkpoint,
                                    lambda_ijepa=opts.ijepa_lambda,
                                    ijepa_img=opts.ijepa_image,
                                    ijepa_in_ch=opts.ijepa_input_channel,
                                    ijepa_warmup_kimg=opts.ijepa_warmup_kimg)
