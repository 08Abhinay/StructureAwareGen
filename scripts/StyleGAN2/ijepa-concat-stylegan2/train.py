...
def setup_training_loop_kwargs(
    ...
    args.G_kwargs.mapping_kwargs.extra_dim = ijepa_dim
    ...
    args.loss_kwargs = dnnlib.EasyDict(class_name='training.loss_ijepa.StyleGAN2IJEPALoss', r1_gamma=spec.gamma, 
...
@click.option('--ijepa_dim', help='what is the ijepa embedding dimension? ', type=int, default=384)
