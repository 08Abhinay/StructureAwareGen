#!/bin/bash
#SBATCH -A standby
#SBATCH -J ijepa_sg2_ChestXray_labelled_4_gpu_norm
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-FiLM-stylegan2/SLRUM_OUTPUT_FILES/ijepa_gan_ChestXray_labelled_256_warmup_kimg_0.05_lambda_1_gpu_4.out
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-FiLM-stylegan2/SLRUM_OUTPUT_FILES/ijepa_gan_ChestXray_labelled_256_warmup_kimg_0.05_lambda_1_gpu_4.err
...
srun --gres=gpu:4 \
  apptainer exec --nv --cleanenv \
      ...
      /opt/conda/bin/python /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-FiLM-stylegan2/train.py \
        --outdir=/scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-FiLM-stylegan2/outputs/final/ijepa_gan_ChestXray_labelled_256_warmup_kimg_0.05_lambda_1_gpu_4/training-runs \
