#!/bin/bash
#SBATCH -A standby
#SBATCH -J ijepa_SG_lossonly_Brain_C_rampGD_warmup_6.4_4gpu_sem_mixing_0.5
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-lossonly-stylegan2/SLRUM_OUTPUT_FILES/ijepa_SG_lossonly_Brain_C_rampGD_warmup_6.4_4gpu_sem_mixing_0.5_FusionAlpha_0.2.out
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-lossonly-stylegan2/SLRUM_OUTPUT_FILES/ijepa_SG_lossonly_Brain_C_rampGD_warmup_6.4_4gpu_sem_mixing_0.5_FusionAlpha_0.2.err
...
srun --gres=gpu:4 \
  apptainer exec --nv --cleanenv \
      ...
      /opt/conda/bin/python /scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-lossonly-stylegan2/train.py \
        --outdir=/scratch/gilbreth/abelde/Thesis/scripts/StyleGAN2/ijepa-lossonly-stylegan2/outputs/Brain/sem_mixing_prob_${SEM_MIX}/ijepa_Brain_C_rampGD_warmup_6.4_4gpu_sem_mix_${SEM_MIX}_FusionAlpha_${FUSION_ALPHA}/training-runs \
