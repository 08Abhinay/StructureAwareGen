#!/bin/bash
#SBATCH -A standby
#SBATCH -J ISD-Brain_labelled
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/ijepa-diffusion-lossonly-stylegan2/SLURM_OUTPUT_FILES/Brainlabelled_ijepa_ISGDiff.out
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/ijepa-diffusion-lossonly-stylegan2/SLURM_OUTPUT_FILES/Brainlabelled_ijepa_ISGDiff.err
...
srun --gres=gpu:4 \
  apptainer exec --nv --cleanenv \
      ...
      /opt/conda/bin/python /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/ijepa-diffusion-lossonly-stylegan2/train.py \
        --outdir=/scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/ijepa-diffusion-lossonly-stylegan2/outputs/final/ijepa_diffgan_Brain_labelled_256/training-runs \
        ...
        --resume /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/ijepa-diffusion-lossonly-stylegan2/outputs/final/ijepa_diffgan_Brain_labelled_256/training-runs/00001-Brain_cancer_labelled-cond-mirror-auto4-target0.6-ada_kimg100-ts_dist-priority-image_augno-noise_sd0.05-resumecustom/best_model.pkl 
