#!/bin/bash
#SBATCH -A standby
#SBATCH -J SD-ChestXray_labelled-requeued 
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/diffusion-stylegan2/SLURM_OUTPUT_FILES/Chest_Xray_labelled_SGDiff.out
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/diffusion-stylegan2/SLURM_OUTPUT_FILES/Chest_Xray_labelled_SGDiff.err
