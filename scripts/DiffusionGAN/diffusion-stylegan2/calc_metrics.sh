#!/bin/bash
#SBATCH -A debug
#SBATCH -J SD-Chest_metric_calc
#SBATCH -e /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/diffusion-stylegan2/SLURM_OUTPUT_FILES/SD-Chest_metric_calc.err
#SBATCH -o /scratch/gilbreth/abelde/Thesis/scripts/Diffusion-GAN/diffusion-stylegan2/SLURM_OUTPUT_FILES/SD-Chest_metric_calc.out
