...
class LightlyModel(pl.LightningModule):
        ...
        if not self.trainer.sanity_checking:
            if self.current_epoch % 5 == 0:
                try:
                    ...
                    print("---- FULL TRACEBACK (online classification) ----", flush=True)
                    traceback.print_exc()
    ...
    def setup(self, stage: str) -> None:
        dataset_classes = {
            ...
            "chestxray-h5":   HDF5ImageFolder,
            "Brain_cancer-h5":  HDF5ImageFolder,
            "lsun_cat":  HDF5ImageFolder,     
        }
        train_dataset_kwargs = {
            ...
            "chestxray-h5": dict(
                root="/scratch/gilbreth/abelde/Thesis/dataset/hdf5/ChestXray_L/chestxray-train.h5",
            ),
            "Brain_cancer-h5": dict(
                root="/scratch/gilbreth/abelde/Thesis/dataset/Brain_cancer/Brain_cancer-train.h5",
            ),
            "lsun_cat": dict(
                root="/scratch/gilbreth/abelde/Thesis/dataset/lsun_cat/lsun_cat-train.h5",
            ),
        }
        val_dataset_kwargs = {
            ...
            "chestxray-h5": dict(
                root="/scratch/gilbreth/abelde/Thesis/dataset/hdf5/ChestXray_L/chestxray-test.h5",
            ),
            "Brain_cancer-h5": dict(
                root="/scratch/gilbreth/abelde/Thesis/dataset/Brain_cancer/Brain_cancer-test.h5",
            ),
            "lsun_cat": dict(
                root="/scratch/gilbreth/abelde/Thesis/dataset/lsun_cat/lsun_cat-test.h5",
            ),
        }
        input_sizes = {
            "cifar10": 32,
    ...
    def train_dataloader(self):
        ...
        print("This is the type: ", type(dataloader))
        return dataloader
